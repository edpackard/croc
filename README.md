Attempt to implement Croc game in vanilla JavaScript.
...
# Initialise river and player starting coordinates
...
river[player_y][player_x] = "P"
river.each do |river_line|
puts river_line
end
river[player_y][player_x] = "-"
...
if player_y == river.size
puts "You survived!"
break
elsif river[player_y][player_x] == "C"
puts "You were eaten!"
break
end
end
